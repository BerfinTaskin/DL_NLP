...
run 0 --batch_size 32 --learning_rate 2e-3 --approach baseline_batch32_3
run 1 --batch_size 32 --learning_rate 2e-4 --approach baseline_batch32_4
run 2 --batch_size 32 --learning_rate 2e-5 --approach baseline_batch32_5
