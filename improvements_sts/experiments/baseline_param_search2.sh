...
############################### === Configuration ===
LOG_NAME="dropout_search2"   # <-- change this to your desired name
LOG_DIR="improvements_sts/logs"
mkdir -p "$LOG_DIR"
...
############################### === Configuration ===
LOG_NAME="dropout_search3"   # <-- change this to your desired name
LOG_DIR="improvements_sts/logs"
mkdir -p "$LOG_DIR"
...
############################### === Configuration ===
LOG_NAME="dropout_search4"   # <-- change this to your desired name
LOG_DIR="improvements_sts/logs"
mkdir -p "$LOG_DIR"
...
############################### === Configuration ===
LOG_NAME="dropout_search5"   # <-- change this to your desired name
LOG_DIR="improvements_sts/logs"
mkdir -p "$LOG_DIR"
